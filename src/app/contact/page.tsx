      ...
      <div className="grid md:grid-cols-2 gap-8 items-start">
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <button
              type="button"
              className="w-full text-sm bg-black hover:bg-gray-600 text-white font-semibold py-3 px-6 rounded-lg transition-colors"
            >
              Send
            </button>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">contact@sfablog.com</p>
                </div>
              </div>
            </div>
          </div>
